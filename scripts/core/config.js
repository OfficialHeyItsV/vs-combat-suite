...
export function initConfig() {
    Handlebars.registerHelper("vcsLocalize", (data, data2, data3) => {
        let str = `.${data}`;
        ...
        return game.i18n.localize(`vs-combat-suite.themeOptions${str}`);
    });

    Handlebars.registerHelper("vcsIfObject", function (item, options) {
